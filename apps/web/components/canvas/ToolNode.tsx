...
export const ToolNode = memo(({ data, selected }: NodeProps) => {
  ...
  return (
    <div
      className={`glass-panel min-w-[220px] rounded-xl p-3.5 transition-all duration-300 ${
        selected ? "border-emerald-500 shadow-lg shadow-emerald-500/20" : ""
      } ${
        status === "running"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-[11px] font-mono text-emerald-400 mt-1">Tool Integration</p>
          </div>
        </div>
